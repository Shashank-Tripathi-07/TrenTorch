...
| 2026-09-01 | Fixed `tren olympics` telling students to run `tito community login`, a command that was fully removed, not renamed. Removed the dead instruction (issue #81) | Maanas Tyagi | TBD | TBD |
