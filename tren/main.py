...
def _get_version() -> str:
    ...
    try:
        ...
        tren_dir = Path(__file__).parent
        pyproject_path = tren_dir.parent / "pyproject.toml"
...
class TrenTorchCLI:
    ...
    def __init__(self):
        ...
        self._tren_dir = self.config.project_root / '.tren'
