    ...
    def _handle_status_command(self, args: Namespace) -> int:
        ...
        if status["next_milestone"]:
            ...
            console.print(Panel(
                ...
                f"[dim]Run each with tren milestone run <id> to actually achieve it.[/dim]",
        ...
        for milestone_id in sorted(MILESTONE_SCRIPTS.keys()):
            ...
            if args.simple:
                ...
                if prereqs_met and not is_complete:
                    milestone_display += f"[bold yellow]▶ Run now:[/bold yellow] [cyan]tren milestone run {milestone_id}[/cyan]\n"
        ...
        if not args.skip_checks:
            ...
            if missing_modules:
                ...
                console.print(Panel(
                    ...
                    "\n".join(f"[dim]  tren module complete {m:02d}[/dim]" for m in missing_modules[:3]),
            ...
            if export_failures:
                console.print(Panel(
                    ...
                    f"[dim]Try re-exporting: tren module complete XX[/dim]",
