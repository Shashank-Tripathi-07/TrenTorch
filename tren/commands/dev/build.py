...
Usage:
    tren dev build html     Build HTML site
    tren dev build serve    Build and serve locally
    tren dev build pdf      Build PDF course guide
    tren dev build paper    Build research paper
"""
