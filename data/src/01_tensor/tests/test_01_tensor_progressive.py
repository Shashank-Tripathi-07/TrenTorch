...
class TestProgressiveStack:
    ...
    def test_environment_enables_tensor(self):
        ...
        tensor_module_path = Path(__file__).parent.parent.parent.parent.parent / "data" / "src" / "01_tensor"
        assert tensor_module_path.exists(), "Module structure missing: data/src/01_tensor"
