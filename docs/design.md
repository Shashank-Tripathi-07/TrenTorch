...
- **`dev/scripts/build-docs.sh` is a stale script** referencing a defunct Jupyter Book documentation pipeline that predates the current Quarto site. It is not invoked by any current CI workflow.
